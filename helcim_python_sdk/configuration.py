...
from helcim_python_sdk.exceptions_base import ApiValueError
from helcim_python_sdk.exceptions import ClientConfigurationError
from helcim_python_sdk.exceptions import InvalidHostConfigurationError
...
conf = helcim_python_sdk.Configuration(
    ...
    def __init__(self, host=None,
        ...
        """Constructor
        """
        self.host = "https://api.helcim.com/v2" if host is None else host
        """Default Base url
        """
        ...
        self.api_key = {}
        if api_access_auth:
            self.api_key['ApiAccessAuth'] = api_access_auth
        else:
            raise ClientConfigurationError('API Key "ApiAccessAuth" is required')
        ...
        """Logging Settings
        """
        self.logger = logging.getLogger("helcim_python_sdk")
    ...
    def auth_settings(self):
        ...
        """
        auth = {}
        if 'ApiAccessAuth' in self.api_key:
            auth['ApiAccessAuth'] = {
                'type': 'api_key',
                'in': 'header',
                'key': 'api-token',
