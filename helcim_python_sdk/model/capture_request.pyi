...
class CaptureRequest(
    ...
    class MetaOapg:
        ...
        class properties:
            preAuthTransactionId = schemas.IntSchema
    ...
    preAuthTransactionId: MetaOapg.properties.preAuthTransactionId
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["preAuthTransactionId"]) -> MetaOapg.properties.preAuthTransactionId: ...
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["preAuthTransactionId", "amount", "ipAddress", "ecommerce", ], str]):
        # dict_instance[name] accessor
        return super().__getitem__(name)
    
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["preAuthTransactionId"]) -> MetaOapg.properties.preAuthTransactionId: ...
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["preAuthTransactionId", "amount", "ipAddress", "ecommerce", ], str]):
    ...
    def __new__(
        ...
        *args: typing.Union[dict, frozendict.frozendict, ],
        ...
        preAuthTransactionId: typing.Union[MetaOapg.properties.preAuthTransactionId, decimal.Decimal, int, ],
