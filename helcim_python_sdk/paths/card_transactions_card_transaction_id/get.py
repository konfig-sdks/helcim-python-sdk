...
# Path params
CardTransactionIdSchema = schemas.IntSchema
RequestRequiredPathParams = typing_extensions.TypedDict(
    'RequestRequiredPathParams',
    {
        'cardTransactionId': typing.Union[CardTransactionIdSchema, decimal.Decimal, int, ],
    }
)
...
request_path_card_transaction_id = api_client.PathParameter(
    name="cardTransactionId",
    style=api_client.ParameterStyle.SIMPLE,
    schema=CardTransactionIdSchema,
    required=True,
)
_auth = [
    'ApiAccessAuth',
...
class BaseApi(api_client.Api):
    ...
    def _get_by_id_mapped_args(
        ...
        if card_transaction_id is not None:
            _path_params["cardTransactionId"] = card_transaction_id
    ...
    async def _aget_by_id_oapg(
        ...
        **kwargs,
        ...
        _path_params = {}
        for parameter in (
            request_path_card_transaction_id,
        ):
        ...
        request_before_hook(
            ...
            path_template='/card-transactions/{cardTransactionId}',
            auth_settings=_auth,
            headers=_headers,
        )
