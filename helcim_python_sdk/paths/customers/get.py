...
from helcim_python_sdk.model.customer_list_response import CustomerListResponse as CustomerListResponseSchema
...
from helcim_python_sdk.type.customer_list_response import CustomerListResponse
...
from helcim_python_sdk.pydantic.customer_list_response import CustomerListResponse as CustomerListResponsePydantic
...
SchemaFor200ResponseBodyApplicationJson = CustomerListResponseSchema
...
class List(BaseApi):
    ...
    async def alist(
        ...
        **kwargs,
        ...
        if validate:
            return RootModel[CustomerListResponsePydantic](raw_response.body).root
        return api_client.construct_model_instance(CustomerListResponsePydantic, raw_response.body)
