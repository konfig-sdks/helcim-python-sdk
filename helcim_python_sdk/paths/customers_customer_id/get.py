...
class GetCustomerRaw(BaseApi):
    ...
    async def aget_customer(
        ...
        **kwargs,
        ...
        args = self._get_customer_mapped_args(
            customer_id=customer_id,
        )
        return await self._aget_customer_oapg(
...
class GetCustomer(BaseApi):
    ...
    async def aget_customer(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.aget_customer(
            customer_id=customer_id,
            **kwargs,
        )
        if validate:
    ...
    def get_customer(
        ...
        raw_response = self.raw.get_customer(
            customer_id=customer_id,
        )
        if validate:
            return CustomerPydantic(**raw_response.body)
