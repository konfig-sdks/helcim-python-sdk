...
class BaseApi(api_client.Api):
    ...
    def _process_purchase_transaction_mapped_args(
        self,
        idempotency_key: str,
    ...
    async def _aprocess_purchase_transaction_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/payment/purchase',
            body=body,
            auth_settings=_auth,
            headers=_headers,
        )
    ...
    def _process_purchase_transaction_oapg(
        self,
        body: typing.Any = None,
            header_params: typing.Optional[dict] = {},
        skip_deserialization: bool = True,
...
class ProcessPurchaseTransactionRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aprocess_purchase_transaction(
        self,
        idempotency_key: str,
        ip_address: typing.Optional[str] = None,
        ecommerce: typing.Optional[bool] = None,
        ...
        **kwargs,
        ...
        args = self._process_purchase_transaction_mapped_args(
            body=body,
        ...
        return await self._aprocess_purchase_transaction_oapg(
            body=args.body,
    ...
    def process_purchase_transaction(
        ...
        return self._process_purchase_transaction_oapg(
            body=args.body,
            header_params=args.header,
        )

class ProcessPurchaseTransaction(BaseApi):
    ...
    async def aprocess_purchase_transaction(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.aprocess_purchase_transaction(
            body=body,
            idempotency_key=idempotency_key,
            ip_address=ip_address,
            ecommerce=ecommerce,
    ...
    def process_purchase_transaction(
        ...
        raw_response = self.raw.process_purchase_transaction(
            body=body,
            idempotency_key=idempotency_key,
            ip_address=ip_address,
            ecommerce=ecommerce,
