...
from helcim_python_sdk.model.card import Card as CardSchema
...
from helcim_python_sdk.model.verify_request import VerifyRequest as VerifyRequestSchema
from helcim_python_sdk.model.address import Address as AddressSchema
from helcim_python_sdk.model.verify_request_invoice import VerifyRequestInvoice as VerifyRequestInvoiceSchema
...
from helcim_python_sdk.type.verify_request import VerifyRequest
from helcim_python_sdk.type.verify_request_invoice import VerifyRequestInvoice

from ...api_client import Dictionary
from helcim_python_sdk.pydantic.card import Card as CardPydantic
from helcim_python_sdk.pydantic.failed_payment_response import FailedPaymentResponse as FailedPaymentResponsePydantic
from helcim_python_sdk.pydantic.verify_request_invoice import VerifyRequestInvoice as VerifyRequestInvoicePydantic
...
from helcim_python_sdk.pydantic.verify_request import VerifyRequest as VerifyRequestPydantic
...
# body param
SchemaForRequestBodyApplicationJson = VerifyRequestSchema


request_body_verify_request = api_client.RequestBody(
    content={
...
class BaseApi(api_client.Api):
    ...
    def _verify_transaction_mapped_args(
        self,
        ip_address: str,
        currency: str,
        card_data: Card,
        ...
        invoice: typing.Optional[VerifyRequestInvoice] = None,
    ...
    async def _averify_transaction_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/payment/verify',
            body=body,
            auth_settings=_auth,
            headers=_headers,
        )
        if body is not schemas.unset:
            serialized_data = request_body_verify_request.serialize(body, content_type)
...
class VerifyTransactionRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def averify_transaction(
        self,
        ip_address: str,
        currency: str,
        card_data: Card,
        ...
        **kwargs,
        ...
        args = self._verify_transaction_mapped_args(
        ...
        return await self._averify_transaction_oapg(
            body=args.body,
    ...
    def verify_transaction(
        ...
        return self._verify_transaction_oapg(
            body=args.body,
            header_params=args.header,
        )

class VerifyTransaction(BaseApi):
    ...
    async def averify_transaction(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.averify_transaction(
            ip_address=ip_address,
            currency=currency,
            card_data=card_data,
            billing_address=billing_address,
    ...
    def verify_transaction(
        ...
        raw_response = self.raw.verify_transaction(
            ip_address=ip_address,
            currency=currency,
            card_data=card_data,
            billing_address=billing_address,
